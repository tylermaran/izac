    ...
    await Promise.all([
      ...
      switch (device_type.name) {
        case 'air_pump':
          ...
          return robots.off_then_on(pin, pour_duration_ms).then(() => {
        ...
        case 'peristaltic_pump':
          ...
          return robots.off_then_on(forwardPin, pour_duration_ms).then(() => {
            ...
            return robots.off_then_on(reversePin, (pour_duration_ms)).then(() => {
